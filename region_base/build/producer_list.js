...
var UrlUtility = function () {
    ...
    _createClass(UrlUtility, [{
        ...
        key: '_generateFolderName',
        value: function _generateFolderName(str, strCountry) {
            var strName = '';
        ...
        key: 'generateRegionPageUrl',
        value: function generateRegionPageUrl(strCountry, strRegion) {
            var url = this.generateCountryPageUrl(strCountry);

            if (strRegion != '' && strRegion != '------------') {
                if (strRegion == 'Languedoc' || strRegion == 'Roussillon') {
                    url += '/languedoc-et-roussillon';
                } else {
                    var strRegionFolder = strRegion ? this._generateFolderName(strRegion, strCountry) : '';
        ...
        key: 'generateCountryPageUrl',
        value: function generateCountryPageUrl(strCountry) {
        ...
        key: 'generateProducerPageUrl',
        value: function generateProducerPageUrl(objProducer) {
...
var _UrlUtility = require('../../../anyway-grapes/singletons/UrlUtility');
        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                for (var i = 0; i < cProducer; ++i) {
                    ...
                    strUrl = _UrlUtility2.default.generateProducerPageUrl(objProducer);

                    html += '<li>' + '<a href="' + strUrl + '" target="_blank"><span class="jpnText" style="font-size:12px;">' + objProducer.name_jpn + '</span>&nbsp;(&nbsp;' + objProducer.name + '&nbsp;)</a>' + '</li>';
                }
...
},{"../../../anyway-grapes/singletons/UrlUtility":1}]},{},[2]);
